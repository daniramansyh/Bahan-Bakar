...
<body>
    <div class="container d-flex flex-column justify-content-center pb-5" style="width: 100%; height: 100vh;">
        ...
        <form class="container bg-light p-5 border border-dark rounded shadow" style="width: 50%; height: auto;" action="logic.php" method="post">
        <div class="text-center mb-3">
            <img src="Shell.png" alt="Logo Shell" style="width: 100px;">
